...
while  i <= iN
    ...
    if ((((pgInput(i, 2) <= vPoint(2)) & (vPoint(2) < pgInput(j, 2)))|((pgInput(j, 2) <= vPoint(2)) & (vPoint(2) < pgInput(i, 2)))) & ..
       (vPoint(1) < ((pgInput(j, 1) - pgInput(i, 1))/(pgInput(j, 2) - pgInput(i, 2))) * (vPoint(2) - pgInput(i, 2)) + pgInput(i, 1)))
