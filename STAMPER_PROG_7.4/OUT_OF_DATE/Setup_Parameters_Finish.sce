...
mNiUndersizeOffsetComponents = [[-.089, 0], [0, 0]];
...
listMultiPassOffsetComponents($+1) = [[0.020 0], [0, 0]; [0.005, 0], [0, 0]; [0.010 0], [0, 0]; [0.002, 0], [0, 0]];
//listMultiPassOffsetComponents($+1) = [[0.050 0], [0, 0]; [0.005, 0], [0, 0]; [0.050 0], [0, 0]; [0.005, 0], [0, 0]];
