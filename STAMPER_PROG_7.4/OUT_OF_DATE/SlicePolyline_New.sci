function listOutput = SlicePolyline_New(plA, plB, bRightHanded)
    listOutput = list();
...
//            vA = lnA(2, :) - lnA(1, :);
//            vB = lnB(2, :) - lnB(1, :);
//            bCrossingHandedness(iIndex) = sign(det([vA; vB])) == 1;
        ...
        bStartPointInBoundary = 1 == int(det([vA; vB]));        
