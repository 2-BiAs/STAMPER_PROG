...
fToolRad = [.07, .05];   //[roughing finish]
...
mNormalOffsetComponents = [[.00, 0], [0, 0]];
...
//listMPOC_FIN($+1) = [[0.004 0], [0, 0]; [0.004, 0], [0, 0]; [0.004 0], [0, 0]; [0.004, 0], [0, 0]];
//listMPOC_FIN($+1) = [[0.005 0], [0, 0]; [0.0015, 0], [0, 0]; [0.005 0], [0, 0]; [0.0015, 0], [0, 0]];
//listMPOC_FIN($+1) = [[0.010 0], [0, 0]; [0.000, 0], [0, 0]; [0.010 0], [0, 0]; [0.000, 0], [0, 0]];

//listMultiPassOffsetComponents($+1) = [[0.010 0], [0, 0]; [0.010, 0], [0, 0]; [0.010 0], [0, 0]; [0.010, 0], [0, 0]];
//listMultiPassOffsetComponents($+1) = [[0.075 0], [0, 0]; [0.075, 0], [0, 0]; [0.075 0], [0, 0]; [0.075, 0], [0, 0]];
